...
public class Application {
    public static void main(String[] args) {
        ...
        aggregator.addHasAreaObj(new Square(10));
        aggregator.addHasAreaObj(new Circle(5));
        aggregator.addHasAreaObj(new Circle(2));
        aggregator.addHasAreaObj(new Ellipse(2, 3));
        aggregator.addHasAreaObj(new Rectangle(10, 5));
        aggregator.addHasAreaObj(new Triangle(10, 2));
        aggregator.addHasAreaObj(new House(100));
